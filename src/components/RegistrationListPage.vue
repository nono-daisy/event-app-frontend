              ...
              <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <tr v-for="ticket in ticketStore.tickets" :key="ticket._id">
                    ...
                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{{ moment(ticket.event.start_date).calendar() }}</td>
...
<!--                        <img class="object-cover w-8 h-8 rounded-full" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt="">-->
                        <div>
                          <h2 class="text-sm font-medium text-gray-800 dark:text-white ">{{ ticket?.applicant_name }}</h2>
                          <p class="text-xs font-normal text-gray-600 dark:text-gray-400">{{ ticket?.email }}</p>
                        </div>
                      </div>
                    </td>
                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{{ ticket?.phone }}</td>
