  ...
  <div class="bg-gray-200 w-full min-h-screen flex items-center justify-center">
    <div class="w-full py-8">
      <div class="bg-white w-5/6 md:w-3/4 lg:w-2/3 xl:w-[500px] 2xl:w-[550px] mt-8 mx-auto px-16 py-8 rounded-lg shadow-2xl">
        ...
        <div  v-if="showPage" class="shadow bg-[#ffd8df] flex rounded items-center  justify-between p-4 gap-2 mt-8">
          <div>
        ...
        <div class="my-8 text-sm">
          ...
          <div class="flex justify-between ">
            ...
            <a href="/signUp" class="text-blue-900 hover:text-blue-900 hover:underline hover:-translate-y-1 duration-500 transition-all">Don't have an account yet?</a>
          </div>

          <div class="my-4 flex items-center justify-end space-x-4">
            <button  type="submit" @click="doLogin" class="bg-blue-900 hover:bg-blue-900 rounded-lg px-8 py-2 text-gray-100 hover:shadow-xl  uppercase hover:-translate-y-1 duration-500 transition-all">Sign In</button>
          </div>
        </div>
      </div>
    </div>
